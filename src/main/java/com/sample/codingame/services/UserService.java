...
import com.sample.codingame.entities.ContestStatus;
import com.sample.codingame.entities.RegisterationStatus;
...
public class UserService implements IUserService {
    ...
    public List<User> getAllUserScoreOrderWise(ScoreOrder scoreOrder){
        // List<User>allUserScoreOrderWise = new ArrayList<User>();
        //we have to return the List of USERS who attended the contests in ASC DESC respoectively
